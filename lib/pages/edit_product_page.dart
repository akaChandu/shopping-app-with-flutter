      ...
      try {
        ...
        await showDialog<Null>(
          ...
          builder: (context) => AlertDialog(
            ...
            content: const Text('Spmething went worng!'),
            actions: [
              TextButton(
                onPressed: () {
                ...
                child: ListView(
                  children: [
                    TextFormField(
                      ...
                      // Focus field for automatic shift into next Form Field
                      onFieldSubmitted: (_) {
                    ...
                    TextFormField(
                      ...
                      // Focus field for automatic shift cursor into this Form Field
